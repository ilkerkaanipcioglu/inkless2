                  ...
                  <CarouselItem key={i} className="pl-4 md:basis-1/2 lg:basis-1/4">
                    <div className="h-full">
                      <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ delay: i * 0.1 }}
                        className="bg-background rounded-3xl overflow-hidden border border-border hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 flex flex-col h-full"
                      >
