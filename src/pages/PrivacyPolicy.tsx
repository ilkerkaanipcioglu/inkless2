    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-grow container mx-auto px-4 py-12 max-w-4xl">
        ...
        >
          ...
          <p>
            This Privacy Policy describes how Inkless Is More (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from www.inklessismore.ke (the "Site") or otherwise communicate with us regarding the Site (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.
          </p>
          <p>
          ...
          <h3 className="text-xl font-semibold mt-6 mb-3">What Personal Information We Collect</h3>
          <p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li><strong>Booking information</strong> including your name, billing address, payment confirmation, email address and phone number.</li>
            <li><strong>Account information</strong> including username, password, security questions and other information used for account security purposes.</li>
          ...
          <p className="mt-4">
            Some features of the Services may require you to directly provide us with certain information about yourself. You may decide not to provide this information, but doing so may prevent you from using or accessing these features.
          </p>

          <h3 className="text-xl font-semibold mt-6 mb-3">Information We Collect about Your Usage</h3>
          <p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Our payment processors, who collect payment information (e.g., bank account, credit or debit card information, billing address) to process your payment in order to fulfill your orders and provide you with services you have requested, in order to perform our contract with you.</li>
          ...
          <p className="mt-4">
            Any information we obtain from third parties will be treated in accordance with this Privacy Policy. Also see the section below, <em>Third Party Websites and Links.</em>
          </p>

          <h3 className="text-xl font-semibold mt-6 mb-3">How We Use Your Personal Information</h3>
          <ul className="list-disc pl-6 space-y-2">
            <li><strong>Providing Products and Services.</strong> We use your personal information to provide you with the Services in order to perform our contract with you, including to process your payments, fulfill your bookings, to send notifications to you related to your account, bookings, refunds or other transactions, to create, maintain and otherwise manage your account, facilitate any refunds and other features and functionalities related to your account.</li>
            <li><strong>Marketing and Advertising.</strong> We may use your personal information for marketing and promotional purposes, such as to send marketing, advertising and promotional communications by email, text message or postal mail, and to show you advertisements for services. This may include using your personal information to better tailor the Services and advertising on our Site and other websites.</li>
          ...
          <p>
            Like many websites, we use Cookies on our Site. For specific information about the Cookies that we use related to powering our store with Shopify, see <a href="https://www.shopify.com/legal/cookies" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">https://www.shopify.com/legal/cookies</a>. We use Cookies to power and improve our Site and our Services (including to remember your actions and preferences), to run analytics and better understand user interaction with the Services (in our legitimate interests to administer, improve and optimize the Services). We may also permit third parties and services providers to use Cookies on our Site to better tailor the services, products and advertising on our Site and other websites.
          </p>
          <p className="mt-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>With vendors or other third parties who perform services on our behalf (e.g., IT management, payment processing, data analytics, customer support and cloud storage).</li>
            ...
            <li>When you direct, request us or otherwise consent to our disclosure of certain information to third parties, such as through your use of social media widgets or login integrations, with your consent.</li>
          ...
          <p>
            Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at <a href="mailto:inklessismore@gmail.com" className="text-primary hover:underline">inklessismore@gmail.com</a> or visit us at The Mirage, Tower 2, Pentoffice 13th floor, 00100, KE.
          </p>
        </motion.div>
      </main>
      <Footer />
